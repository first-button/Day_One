      ...
      steps: [
        {
          icon: Upload,
          title: "1. 파일 업로드",
          description: "PDF, Word, 이미지 파일을 드래그하거나 클릭하여 업로드하세요."
        },
        {
          icon: Calendar,
          title: "2. AI 자동 인식",
          description: "AI가 자동으로 문서 속 일정을 인식하고 추출합니다. 평균 3초 소요!"
        },
        {
          icon: CheckCircle,
          title: "3. 캘린더에 저장",
          description: "인식된 일정이 자동으로 Google 캘린더에 추가됩니다."
        }
      ]
    },
    en: {
      steps: [
        {
          icon: Upload,
          title: "1. Upload File",
          description: "Drag or click to upload PDF, Word, or image files."
        },
        {
          icon: Calendar,
